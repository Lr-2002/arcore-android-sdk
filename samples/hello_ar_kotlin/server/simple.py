...
def main():
    ...
    model = mujoco.MjModel.from_xml_path('/Users/lr-2002/project/reasoning_manipulation/ar_android/arcore-android-sdk/samples/hello_ar_kotlin/server/demos/simple_scene.xml')
